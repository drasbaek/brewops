...
2. Classifies each file by filename prefix (see [csv-formats.md](../reference/csv-formats.md)):
...
3. Validates and inserts each row. Bad rows are skipped and recorded — the rest of the
   file still loads. See [validation-rules.md](../reference/validation-rules.md).
