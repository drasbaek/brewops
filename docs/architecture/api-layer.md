...
Full detail in [api-endpoints.md](../reference/api-endpoints.md).
...
raise `HTTPException(400, ...)`. See [validation-rules.md](../reference/validation-rules.md)
and [timestamps.md](../data-model/timestamps.md).
